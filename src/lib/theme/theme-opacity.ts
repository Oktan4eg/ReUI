...
export const lightTheme: DefaultTheme = {
  colors: {
    ...
    neutral: {
      ...
      // },
      inverse: {
        primary: palette.neutral[24] + palette.opacity[16],
        secondary: palette.neutral[24] + palette.opacity[8],
        tertiary: palette.neutral[24] + palette.opacity[4],
        hover: palette.neutral[24] + palette.opacity[20],
        active: palette.neutral[24] + palette.opacity[24],
        contrast: palette.neutral[12],
      },
    },
    // inverse: {
    ...
    lead: {
      ...
      inverse: {
        primary: palette.purple[50] + palette.opacity[16],
        secondary: palette.purple[50] + palette.opacity[8],
        tertiary: palette.purple[50] + palette.opacity[4],
        hover: palette.purple[50] + palette.opacity[20],
        active: palette.purple[50] + palette.opacity[24],
    ...
    success: {
      ...
      inverse: {
        primary: palette.green[50] + palette.opacity[16],
        secondary: palette.green[50] + palette.opacity[8],
        tertiary: palette.green[50] + palette.opacity[4],
        hover: palette.green[50] + palette.opacity[20],
        active: palette.green[50] + palette.opacity[24],
    ...
    distuctive: {
      ...
      inverse: {
        primary: palette.red[50] + palette.opacity[16],
        secondary: palette.red[50] + palette.opacity[8],
        tertiary: palette.red[50] + palette.opacity[4],
        hover: palette.red[50] + palette.opacity[20],
        active: palette.red[50] + palette.opacity[24],
    ...
    info: {
      ...
      inverse: {
        primary: palette.blue[50] + palette.opacity[16],
        secondary: palette.blue[50] + palette.opacity[8],
        tertiary: palette.blue[50] + palette.opacity[4],
        hover: palette.blue[50] + palette.opacity[20],
        active: palette.blue[50] + palette.opacity[24],
    ...
    warning: {
      ...
      inverse: {
        primary: palette.orange[50] + palette.opacity[16],
        secondary: palette.orange[50] + palette.opacity[8],
        tertiary: palette.orange[50] + palette.opacity[4],
        hover: palette.orange[50] + palette.opacity[20],
        active: palette.orange[50] + palette.opacity[24],
...
export const darkTheme = {
  ...
  colors: {
    ...
    neutral: {
      ...
      inverse: {
        primary: palette.neutral[12] + palette.opacity[16],
        secondary: palette.neutral[12] + palette.opacity[8],
        tertiary: palette.neutral[12] + palette.opacity[4],
        hover: palette.neutral[12] + palette.opacity[20],
        active: palette.neutral[12] + palette.opacity[24],
        contrast: palette.neutral[96],
      },
    },
    // inverse: {
    ...
    lead: {
      ...
      inverse: {
        primary: palette.purple[15] + palette.opacity[16],
        secondary: palette.purple[15] + palette.opacity[8],
        tertiary: palette.purple[15] + palette.opacity[4],
        hover: palette.purple[15] + palette.opacity[20],
        active: palette.purple[15] + palette.opacity[24],
    ...
    success: {
      ...
      inverse: {
        primary: palette.green[15] + palette.opacity[16],
        secondary: palette.green[15] + palette.opacity[8],
        tertiary: palette.green[15] + palette.opacity[4],
        hover: palette.green[15] + palette.opacity[20],
        active: palette.green[15] + palette.opacity[24],
    ...
    distuctive: {
      ...
      inverse: {
        primary: palette.red[15] + palette.opacity[16],
        secondary: palette.red[15] + palette.opacity[8],
        tertiary: palette.red[15] + palette.opacity[4],
        hover: palette.red[15] + palette.opacity[20],
        active: palette.red[15] + palette.opacity[24],
    ...
    info: {
      ...
      inverse: {
        primary: palette.blue[15] + palette.opacity[16],
        secondary: palette.blue[15] + palette.opacity[8],
        tertiary: palette.blue[15] + palette.opacity[4],
        hover: palette.blue[15] + palette.opacity[20],
        active: palette.blue[15] + palette.opacity[24],
    ...
    warning: {
      ...
      inverse: {
        primary: palette.orange[15] + palette.opacity[16],
        secondary: palette.orange[15] + palette.opacity[8],
        tertiary: palette.orange[15] + palette.opacity[4],
        hover: palette.orange[15] + palette.opacity[20],
        active: palette.orange[15] + palette.opacity[24],
