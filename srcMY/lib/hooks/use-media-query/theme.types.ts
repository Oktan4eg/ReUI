...
export type MantineBreakpointsValues = Record<
  MantineSize | (string & {}),
  string
>;
export type MantineFontSizesValues = Record<
  MantineSize | (string & {}),
  string
>;
...
export type MantineLineHeightValues = Record<
  MantineSize | (string & {}),
  string
>;
...
export type MantineSpacing =
  | keyof MantineSpacingValues
  | (string & {})
  | number;
